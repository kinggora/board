...
<h1>게시판 - 등록</h1>
<div>
  <form:form name="write" modelAttribute="post" method="post" enctype="multipart/form-data">
    <table>
      <tr>
        <td>카테고리</td>
      ...
      <tr>
        <td>내용</td>
        <td><form:textarea path="content" cols="50" rows="10"/><form:errors path="content"/></td>
      </tr>
      <tr>
        <td>파일 첨부</td>
        <td>
